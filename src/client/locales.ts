...
export const ZH_DICTIONARY: WorkbenchDictionary = {
  ...
  'ai.outputInserted': '智能体产出已自动插入光标',
  'ai.send': '发送给智能体',
  'ai.sent': '已发送给智能体。回复完成后：选中回复内容 → 「捕获选中内容」 → 「插入到光标」',
  ...
  'ai.hint': '流程：这里描述需求 → 智能体在对话区回复 → 选中回复 → 捕获 → 插入光标。',
...
export const EN_DICTIONARY: WorkbenchDictionary = {
  ...
  'ai.outputInserted': 'Agent output auto-inserted at the caret',
  'ai.send': 'Send to agent',
  'ai.sent': 'Sent to the agent. When the reply is ready: select it -> "Capture selection" -> "Insert at caret"',
  ...
  'ai.hint': 'Flow: describe here -> agent replies in the conversation area -> select the reply -> capture -> insert at caret.',
